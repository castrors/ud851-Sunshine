 ...
 */
public class SendDataActivity extends Activity implements
    ...
    private class DataItemGenerator implements Runnable {
        ...
        @Override
        public void run() {
//            WearableUtils.notify(getApplicationContext(), mGoogleApiClient);

            Resources resources = getApplicationContext().getResources();

            int smallArtResourceId = SunshineWeatherUtils
                    .getSmallArtResourceIdForWeatherCondition(300);
            Bitmap smallIcon = BitmapFactory.decodeResource(resources, smallArtResourceId);

            sendDataItem(WEATHER_ICON_PATH, WEATHER_ICON_KEY, -1, toAsset(smallIcon));
            sendDataItem(WEATHER_MAX_PATH, WEATHER_MAX_KEY, 15, null);
            sendDataItem(WEATHER_MIN_PATH, WEATHER_MIN_KEY, 5, null);
        }

        private void sendDataItem(String path, String key, int value, Asset asset) {
